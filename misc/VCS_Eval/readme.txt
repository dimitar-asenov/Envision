...
Each .tar file contains a git repository and some files. The name of the tar file indicates which is the corresponding envision project in Envision/DebugBuild/projects.
